package cn.mrxccc.mail.controller;
...
public class EmailController {
    ...
    public String sendAttachmentsMail() {
        ...
        try {
            ...
            // 传入附件
            FileSystemResource file = new FileSystemResource(new File(this.getClass().getResource("/alarm3.jpg").getPath()));
            helper.addAttachment("alarm3.jpg", file);
            jms.send(message);
            return "发送成功";
        } catch (Exception e) {
            e.printStackTrace();
